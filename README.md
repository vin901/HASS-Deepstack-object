...
- **prev_objs_ignore**: (optional, default `true`) Ignore objects if it's bounding box is within prev_objs_pct % difference. Ignored objects are green color.
- **prev_objs_pct**: (optional, default 0.02) The percentage plus or minus difference of bounding box to be ignored if prev_objs_ignore set to true. 
